export declare const ComposedChart: import("react").ForwardRefExoticComponent<
  import("./generateCategoricalChart").CategoricalChartProps &
    import("react").RefAttributes<{
      ...
      throttleTriggeredAfterMouseMove: import("lodash").DebouncedFunc<
        (e: import("./generateCategoricalChart").MousePointer) => any
      >;
      ...
      context: unknown;
      setState<K extends keyof import("./types").CategoricalChartState>(
        state:
          ...
          | ((
              ...
              | import("./types").CategoricalChartState
              | Pick<import("./types").CategoricalChartState, K>)
          | Pick<import("./types").CategoricalChartState, K>,
        callback?: () => void,
      ): void;
